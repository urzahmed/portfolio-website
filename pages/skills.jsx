  ...
  const data = [
    {
      title: "C++",
      id: 0,
      main: "/icons/cplusplus.svg",
      desc: "best Programming Language that is close to me",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    ...
    },
    {
      ...
      id: 3,
      main: "/icons/java.svg",
      desc: "Most Used OOPS Programming language",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    ...
    },
    {
      title: "Express.js",
      id: 8,
      main: "/icons/expressjs.svg",
      desc: "Javascript framework for writing backend application",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    ...
    },
    {
      title: "Socket.io",
      id: 11,
      main: "/icons/socketio.svg",
      desc: "A library that enables low-latency, bidirectional and event-based communication between a client and a server",
    ...
    },
    {
      ...
      desc: "Postman is a standalone software testing API",
      tag: "developer tool",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
